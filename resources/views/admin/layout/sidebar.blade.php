<div class="main-sidebar">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class=""><a class="nav-link" href="{{ route('admin_category_show') }}"><i class="fas fa-hand-point-right"></i> <span>Categories</span></a></li>

                    <li class=""><a class="nav-link" href="{{ route('admin_product_show') }}"><i class="fas fa-hand-point-right"></i> <span>Products</span></a></li>
